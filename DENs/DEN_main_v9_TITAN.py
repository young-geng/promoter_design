...
FLAGS, FLAGS_DEF = mlxu.define_flags_with_default(
    ...
    loss_config_updates=ConfigDict({"diff_exp_cell_ind": 0, "diversity_loss_coef": 5.0, "entropy_loss_coef": 5.0}),
...
def main(argv):
    ...
    print("Optimizing for expression in {} using diversity_loss_coef = {}, entropy_loss_coef = {}".format(id_to_cell[FLAGS.loss_config_updates.diff_exp_cell_ind], FLAGS.loss_config_updates.diversity_loss_coef, FLAGS.loss_config_updates.entropy_loss_coef))
    ...
    final_sequences_iterator = DENValidationDataset(FLAGS.batch_size, generator_latent_size, FLAGS.num_sequences_to_generate).batch_iterator(pmap_axis_dim=jax_device_count)
