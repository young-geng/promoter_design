...
def main(argv):
    ...
    np.save(os.path.join(logger.output_dir, 'val_sequences.npy'), val_sequences)
    ...
    np.save(os.path.join(logger.output_dir, 'prefinal_sequences.npy'), final_sequences)
    np.save(os.path.join(logger.output_dir, 'prefinal_sequences_predicted_exps.npy'), final_sequences_predicted_exps)
    np.save(os.path.join(logger.output_dir, 'prefinal_sequences_filter_out.npy'), filter_out)
