...
FLAGS, FLAGS_DEF = mlxu.define_flags_with_default(
    ...
    loss_config_updates=ConfigDict({"diff_exp_cell_ind": 0, "diversity_loss_coef": 10.0, "entropy_loss_coef": 10.0,  "target_cell_exp_weight": 1.0}),
...
def main(argv):
    ...
    FLAGS.loss_config_updates.target_cell_exp_weight = float(FLAGS.loss_config_updates.target_cell_exp_weight)
    ...
    print("Optimizing for expression in {} using target_cell_exp_weight = {}, diversity_loss_coef = {}, entropy_loss_coef = {}".format(id_to_cell[FLAGS.loss_config_updates.diff_exp_cell_ind], FLAGS.loss_config_updates.target_cell_exp_weight, FLAGS.loss_config_updates.diversity_loss_coef, FLAGS.loss_config_updates.entropy_loss_coef))
