...
export pretrained_predictor_path=/global/scratch/users/aniketh/promoter_modelling/jax_data/trained_predictors/coms_0.01_thp1_2.0.pkl
...
export experiment_id=DEN_v2_optimize_Jurkat_using_coms_0.01_thp1_2.0.pkl_1080ti
